...
if current_path in sys.path:
    print(
        "Removing project path from sys.path to force the imports to start with the project package name",
        current_path,
    )
...
if project_path not in sys.path:
    print(
        "Adding project path to sys.path to mimick a project being installed as a library:",
        project_path,
    )
